...
class TestMLPMixer(unittest.TestCase):
    def test_output_shape(self):
        ...
        model = Model(patch_size=32, num_mixers_layers=2, hidden_size = 768, channels_dim = 256, tokens_dim= 256, dropout=0.2, attach_head= False, num_classes=1000, deterministic= None)
